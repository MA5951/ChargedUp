...
public final class GripperConstants {
    public static final double OPEN_POSITION = Math.toRadians(105);
    public static final double CLOSE_POSITION = Math.toRadians(31.75);
    ...
    public static final double OPENING_POWER = 0; //TODO

    public static final double GRIPPER_TOLERANCE = 0; //TODO

    public static final double GEAR = 1/100;

    public static final double CUBE_ANGLE = 0; //TODO
